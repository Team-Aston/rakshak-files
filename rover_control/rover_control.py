                ...
                for wp in waypoints:
                    ...
                    while True:
                        ...
                        if speed_left > 0 and speed_right > 0 and latest_scan is not None:
                            ...
                            if not front_clear:
                                print("[Obstacle Detected] Stopping and taking action...")
                                vehicle.simple_goto(current_location, groundspeed=0)  # Pause navigation
                                if left_clear:
                                    print("[Action] Turning right")
                                    speed_left = -50
                                    speed_right = 50
                                    ...
                                    speed_left = 0
                                    speed_right = 0
                                # Wait until obstacle clears or turn completes
                                while not front_clear and latest_scan is not None:
                                    front_clear, _, _ = process_scan(latest_scan)
                                    time.sleep(0.5)
