...
def scale_servo_to_speed(servo_value):
    ...
    if servo_value is None:
        return 0
    # Maps servo_value (1000-2000 µs) to -200 to 200, centered around 1735
...
def main():
    ...
    parser.add_argument('--lidar', type=str, default='/dev/ttyUSB1', help='LiDAR port (e.g., /dev/ttyUSB1)')
    ...
    try:
        while True:
            ...
            # Convert servo values to wheel speeds
