    ...
    try:
        while True:
            ...
            speed_left = max(-100, min(100, speed_left))    # Limit speed to range -100 to 100
              ...
              # === RC Channel 6 Audio Logic ===
            rc_value = vehicle.channels.get('8')  # Returns int or None
            global last_switch_position  # Add this at top of function or file if needed
            ...
            if rc_value is not None and rc_value != 0:
                ...
                # Play audio only when switch position changes
                if switch_position != last_switch_position:
                    print(f"[RC Switch] Channel 6 in {switch_position} position")
            ...
            # === End of RC Channel 6 Audio Logic ===
